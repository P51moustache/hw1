...
INSERT INTO movie (id, title, year_released, rating, studio_id) VALUES
...
SELECT movie.title, movie.year_released, movie.rating, studio.name
FROM movie
...
SELECT movie.title, actor.name, casting.character_name
FROM casting
